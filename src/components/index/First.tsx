...
// How long one full zoom-in/zoom-out breath of the background takes. Kept a
// whole multiple of BG_ROTATE_SECONDS so the slow pan stays in step with the
// image crossfade instead of drifting against it.
const KEN_BURNS_SECONDS = 40;
const BG_ROTATE_SECONDS = 10;

```meta
title: "Presentation Version - Project 3 - Photo Essay"
location: London
date: 2025-9-7
tags: [ENGL1101]
...
>
> * 8:00 AM Try to wake up and fail
> * 9:00 AM Actually get up, work on project A
> * 10:00 AM Review / Project B
> * 11:20 AM ENGL1101
> * 1:00 PM Cup noodles
> * 1:30 PM HTS1031
> * 3:00 PM Review / Project C
> * 6:00 PM Dinner
> * 6:30 PM Project D
> * 10:00 PM Go to bed, set alarms

<Tile images={[
  "https://blob.harvey-l.com/f9cf32f0609c8c1435a235bc3b74e5d7.webp",
  "https://blob.harvey-l.com/be34d306fbcc4d994b5992558504389a.webp",
]} captions={[
  "Cup noodles",
  "Alarms"
]} />
...
<Tile images={[
  ...
  "https://blob.harvey-l.com/7f3adb0ac81f198430acf20252840a18.webp",
]} captions={[
  "Strangers in a pub",
...
<div class="flex gap-5 items-center md:flex-row flex-col my-10">
  <p class="h-fit m0!">
    Boarded the south bound train, I sit next to the window. Earlier, the uninvited dawn had forced me to open.  Now, the sunset invites me to pause. Five hours for depth.  Five hours for looking out and back.  I still run the algorithm, but it includes a field it once omitted: “blank-space.” The sun continues to chase the train. I let the scene unfold without converting it into a plan.
